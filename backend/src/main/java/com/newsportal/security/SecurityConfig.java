    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/news/*/comments").authenticated()

                        // Editor and Admin endpoints
                        .requestMatchers("/api/backoffice/**").hasAnyRole("EDITOR", "ADMIN")
                        .requestMatchers(HttpMethod.POST, "/api/news").hasAnyRole("EDITOR", "ADMIN")
